...
def main():
    ...
    for idx, filename in enumerate(os.listdir(path)):
        ...
        if (
            ...
            test[appliance_name] = (
                test[appliance_name] - params_appliance[appliance_name]["mean"]
            ) / params_appliance[appliance_name]["std"]
            ...
            val[appliance_name] = (
                val[appliance_name] - params_appliance[appliance_name]["mean"]
            ) / params_appliance[appliance_name]["std"]
            ...
            try:
                ...
                csv[appliance_name] = (
                    csv[appliance_name] - params_appliance[appliance_name]["mean"]
                ) / params_appliance[appliance_name]["std"]
                ...
                csv.to_csv(
                    save_path + appliance_name + "_training_.csv",
                    mode="a",
                    index=False,
                    header=False,
                )
